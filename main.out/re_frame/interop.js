...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__15065 = cljs.core.instance_QMARK_;
var expr__15066 = reactive_val;
if(cljs.core.truth_((pred__15065.cljs$core$IFn$_invoke$arity$2 ? pred__15065.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__15066) : pred__15065.call(null,reagent.ratom.RAtom,expr__15066)))){
return "ra";
} else {
if(cljs.core.truth_((pred__15065.cljs$core$IFn$_invoke$arity$2 ? pred__15065.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__15066) : pred__15065.call(null,reagent.ratom.RCursor,expr__15066)))){
return "rc";
} else {
if(cljs.core.truth_((pred__15065.cljs$core$IFn$_invoke$arity$2 ? pred__15065.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__15066) : pred__15065.call(null,reagent.ratom.Reaction,expr__15066)))){
return "rx";
} else {
if(cljs.core.truth_((pred__15065.cljs$core$IFn$_invoke$arity$2 ? pred__15065.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__15066) : pred__15065.call(null,reagent.ratom.Track,expr__15066)))){
return "tr";
} else {
return "other";
}
