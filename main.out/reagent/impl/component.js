...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__14837 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__14837) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__14837));
})());
} else {
var v = temp__5459__auto__;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14839 = c;
var G__14839__$1 = (((G__14839 == null))?null:G__14839.prototype);
if((G__14839__$1 == null)){
return null;
} else {
return (G__14839__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14841 = c;
var G__14841__$1 = (((G__14841 == null))?null:G__14841.prototype);
if((G__14841__$1 == null)){
return null;
} else {
return (G__14841__$1["render"]);
}
})() == null)));
});
...
var G__14843 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__14843) : reagent.impl.component.as_element.call(null,G__14843));
};
...
while (G__14846__i < G__14846__a.length) {G__14846__a[G__14846__i] = arguments[G__14846__i + 0]; ++G__14846__i;}
  args = new cljs.core.IndexedSeq(G__14846__a,0,null);
} 
...
var _STAR_current_component_STAR_14849 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14849;
}});
...
return ((function (G__14850,G__14850__$1){
...
var c = this;
var G__14851_14853 = (c["cljsRatom"]);
if((G__14851_14853 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14851_14853);
}
...
var renders_14855 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_14856 = cljs.core.first(cljs.core.vals(renders_14855));
if((cljs.core.count(renders_14855) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_14855))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_14856)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_14856], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__14854 = name;
switch (G__14854) {
case "":
...
var G__14859 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__14859) : reagent.impl.component.global$module$create_react_class.call(null,G__14859));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__14860 = fiber;
var G__14860__$1 = (((G__14860 == null))?null:(G__14860["type"]));
if((G__14860__$1 == null)){
return null;
} else {
return (G__14860__$1["displayName"]);
}
})();
var parent = (function (){var G__14861 = fiber;
if((G__14861 == null)){
return null;
} else {
return (G__14861["return"]);
}
})();
var path = (function (){var G__14862 = parent;
var G__14862__$1 = (((G__14862 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__14862) : reagent.impl.component.fiber_component_path.call(null,G__14862)));
if((G__14862__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14862__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var G__14863 = c;
if((G__14863 == null)){
return null;
} else {
return (G__14863["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__14864 = (function (){var or__8808__auto__ = (function (){var G__14866 = c;
if((G__14866 == null)){
return null;
} else {
return (G__14866["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__8808__auto__)){
return or__8808__auto__;
...
return (G__14864["_currentElement"]);
}
})();
var name = (function (){var G__14867 = elem;
var G__14867__$1 = (((G__14867 == null))?null:(G__14867["type"]));
if((G__14867__$1 == null)){
return null;
} else {
return (G__14867__$1["displayName"]);
}
})();
var path = (function (){var G__14868 = elem;
var G__14868__$1 = (((G__14868 == null))?null:(G__14868["_owner"]));
var G__14868__$2 = (((G__14868__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__14868__$1) : reagent.impl.component.component_path.call(null,G__14868__$1)));
if((G__14868__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14868__$2)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__14869 = c;
var G__14869__$1 = (((G__14869 == null))?null:G__14869.constructor);
if((G__14869__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__14869__$1);
}
}
})();
