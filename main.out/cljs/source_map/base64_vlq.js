...
var digit_16736 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_16737__$1 = (vlq >>> (5));
while(true){
if((vlq_16737__$1 > (0))){
var digit_16738__$1 = (digit_16736 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_16738__$1));

var G__16739 = (vlq_16737__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__16740 = (vlq_16737__$1 >>> (5));
digit_16736 = G__16739;
vlq_16737__$1 = G__16740;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_16736));
}
break;
}
...
var G__16741 = i__$1;
var G__16742 = result__$1;
var G__16743 = shift__$1;
i = G__16741;
result = G__16742;
shift = G__16743;
continue;
